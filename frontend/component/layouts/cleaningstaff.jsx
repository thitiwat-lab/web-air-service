                    ...
                    {userid.map((v,i)=>{
                      return(
                        <div key={i+'auth'}>
                          ...
                          <div className="row">
                                <p className="margin-cleaningstaff">สิทธิการใช้งาน: {v.userrights}</p>
                          </div>
                        </div>
                      )
                    })}
                        ...
                        <ul className="demo">
                        <LinkActive title="การจองคิว" to="/cleaningstaff/reportreservation" icon="fas fa-address-book" />
                        <LinkActive title ="ข้อมูลลูกค้า" to="/cleaningstaff/member" icon="fas fa-users"/>
                        <LinkActive title="ข้อมูลพิกัดบ้านลูกค้า" to="/cleaningstaff/tablemaps" icon="fas fa-map-marker-alt" />
                        <LinkActive title="ประมวลผลค่าใช้จ่าย" to="/cleaningstaff/reportincome" icon="fas fa-address-card" /> 
                        </ul> 
                    </div>
                </div>
